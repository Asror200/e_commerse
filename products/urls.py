...
urlpatterns = [
                  ...
                  path('Redister-page/', auth_views.register_user, name='register'),
                  path('login-page/', auth_views.login_user, name='login_page'),
                  path('login-page/', auth_views.login_user, name='login'),
                  path('logout-page/', auth_views.logout_user, name='logout_page'),
                  path('logout-page/', auth_views.logout_user, name='logout'),
